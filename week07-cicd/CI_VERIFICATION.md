...
```
https://github.com/Simeonk1307/DS5619-MLOPS/actions/runs/35694499366
```
...
1. the workflow not being in the root was one issue
2. the path was wrong for integration testing once fixing it it was fine.
