        ...
        if _is_null(value):
            violation_objects.append(
                Violation(
                    ...
                    column=column,
                    row_index=i,
                    detail=f"{i}th row has {column} which is null/empty '{value}'"
                )
            )
        ...
        try:
            if float(value) <= 0:
                violation_objects.append(
                    Violation(
                        ...
                        column=column,
                        row_index=i,
                        detail=f"{i}th row has {column} with value '{value}' which is not positive."
                    )
                )
            ...
            violation_objects.append(
                Violation(
                    ...
                    column=column,
                    row_index=i,
                    detail=f"{i}th row has {column} with value '{value}' which cannot be cast to float: {err}"
                )
            )
    return violation_objects
        ...
        if value not in allowed_set:
            violation_objects.append(
                Violation(
                    ...
                    column=column,
                    row_index=i,
                    detail=f"{i}th row has {column} value '{value}' which is not in allowed set '{allowed_set}'"
                )
            )
    return violation_objects
        ...
        if value in seen_values:
            violation_objects.append(
                Violation(
                    ...
                    column=column,
                    row_index=i,
                    detail=f"{i}th row has duplicate {column} value '{value}'."
                )
            )
        else:
